...
export default function PersonalInfos() {
  ...
  return (
    <div className={styles.aboutMe}>
      <div
        className={styles.picture + " " + utils.boxshadowBlue}
        data-aos="fade-right"
      >
        <Image
      ...
      <div className={styles.bio + " " + utils.textBio} data-aos="fade-left">
        ...
        <p>
          ...
          <br />
          I&apos;m Emmanuel Bli, I&apos;m from Ivory Coast and since my
          childhood I was very passionated about technology. My love of
          technology lead me into programming and I have had a computer science
          degree. Apart from my diploma, I&apos;m also a self-taught man always
          learning new stuffs to expand his skills.
        </p>
        <p>
          Why should you entrust me with your project?
          <br />
          I&apos;m someone who puts it heart in every job he does. Punctuality
          and seriousness are my virtues, I make a point of finishing correctly
          my work on time.
        </p>

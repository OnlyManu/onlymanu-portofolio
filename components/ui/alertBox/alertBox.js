            ...
            return createPortal(
                <div className={isOpen ? styles.alert + " " + styles.open : styles.alert} >
                    <div className={styles.alertBox}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" className={styles.alertIcon+" "+utils.svgColorBlue}>
                        ...
                        <div className={styles.alertText}>
                            <span className={styles.headingAlert+" "+utils.colorBlue}>Well done</span>
                            <span className={styles.textAlert+" "+utils.colorBlack}>{ children }</span>
                        </div>
                        <button className={styles.alertButton+" "+utils.colorWhite+" "+utils.bgColorBlue} onClick={close}>Continue</button>
                    </div>
